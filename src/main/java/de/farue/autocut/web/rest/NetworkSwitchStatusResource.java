...
public class NetworkSwitchStatusResource {
    ...
    public ResponseEntity<NetworkSwitchStatus> createNetworkSwitchStatus(@Valid @RequestBody NetworkSwitchStatus networkSwitchStatus)
    ...
    public ResponseEntity<NetworkSwitchStatus> updateNetworkSwitchStatus(
        ...
        @Valid @RequestBody NetworkSwitchStatus networkSwitchStatus
    ) throws URISyntaxException {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/network-switch-statuses/{id}", consumes = "application/merge-patch+json")
    public ResponseEntity<NetworkSwitchStatus> partialUpdateNetworkSwitchStatus(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody NetworkSwitchStatus networkSwitchStatus
    ) throws URISyntaxException {
