...
public class BroadcastMessageService {
    ...
    public BroadcastMessageService(BroadcastMessageRepository broadcastMessageRepository, LoggedInUserService loggedInUserService) {
    ...
    public List<BroadcastMessage> findAllActive() {
        return broadcastMessageRepository.findAllActiveAt(Instant.now(), loggedInUserService.isLoggedIn());
    }
}
