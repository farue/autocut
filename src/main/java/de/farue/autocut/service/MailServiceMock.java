...
public class MailServiceMock extends MailService {
    ...
    public MailServiceMock(JHipsterProperties jHipsterProperties, JavaMailSenderImpl javaMailSender,
    ...
    public void sendEmail(String to, String subject, String content, boolean isMultipart, boolean isHtml) {
        log.debug("Mocking send email[multipart '{}' and html '{}'] to '{}' with subject '{}' and content={}",
