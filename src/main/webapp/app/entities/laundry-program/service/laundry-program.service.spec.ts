  ...
  describe('Service methods', () => {
    ...
    describe('addLaundryProgramToCollectionIfMissing', () => {
      ...
      it('should add only unique LaundryProgram to an array', () => {
        const laundryProgramArray: ILaundryProgram[] = [{ id: 123 }, { id: 456 }, { id: 38042 }];
      ...
      it('should return initial array if no LaundryProgram is added', () => {
        const laundryProgramCollection: ILaundryProgram[] = [{ id: 123 }];
        expectedResult = service.addLaundryProgramToCollectionIfMissing(laundryProgramCollection, undefined, null);
        expect(expectedResult).toEqual(laundryProgramCollection);
      });
    });
  });
