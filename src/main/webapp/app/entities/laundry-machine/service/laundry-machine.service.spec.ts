  ...
  describe('Service methods', () => {
    ...
    describe('addLaundryMachineToCollectionIfMissing', () => {
      ...
      it('should add only unique LaundryMachine to an array', () => {
        const laundryMachineArray: ILaundryMachine[] = [{ id: 123 }, { id: 456 }, { id: 52764 }];
      ...
      it('should return initial array if no LaundryMachine is added', () => {
        const laundryMachineCollection: ILaundryMachine[] = [{ id: 123 }];
        expectedResult = service.addLaundryMachineToCollectionIfMissing(laundryMachineCollection, undefined, null);
        expect(expectedResult).toEqual(laundryMachineCollection);
      });
    });
  });
