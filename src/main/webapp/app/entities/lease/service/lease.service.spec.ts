  ...
  describe('Service methods', () => {
    ...
    describe('addLeaseToCollectionIfMissing', () => {
      ...
      it('should add only unique Lease to an array', () => {
        const leaseArray: ILease[] = [{ id: 123 }, { id: 456 }, { id: 75031 }];
      ...
      it('should return initial array if no Lease is added', () => {
        const leaseCollection: ILease[] = [{ id: 123 }];
        expectedResult = service.addLeaseToCollectionIfMissing(leaseCollection, undefined, null);
        expect(expectedResult).toEqual(leaseCollection);
      });
    });
  });
