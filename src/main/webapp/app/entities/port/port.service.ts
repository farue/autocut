...
type EntityResponseType = HttpResponse<IPort>;
type EntityArrayResponseType = HttpResponse<IPort[]>;

@Injectable({ providedIn: 'root' })
export class PortService {
  public resourceUrl = SERVER_API_URL + 'api/ports';
  ...
  update(port: IPort): Observable<EntityResponseType> {
    return this.http.put<IPort>(this.resourceUrl, port, { observe: 'response' });
  }
