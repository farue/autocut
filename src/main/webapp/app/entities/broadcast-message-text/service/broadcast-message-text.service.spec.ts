    ...
    describe('Service methods', () => {
      ...
      describe('addBroadcastMessageTextToCollectionIfMissing', () => {
        ...
        it('should add only unique BroadcastMessageText to an array', () => {
          const broadcastMessageTextArray: IBroadcastMessageText[] = [{ id: 123 }, { id: 456 }, { id: 61060 }];
          const broadcastMessageTextCollection: IBroadcastMessageText[] = [{ id: 123 }];
          expectedResult = service.addBroadcastMessageTextToCollectionIfMissing(
            broadcastMessageTextCollection,
            ...broadcastMessageTextArray
          );
