  ...
  describe('Service methods', () => {
    ...
    describe('addNetworkSwitchToCollectionIfMissing', () => {
      ...
      it('should add only unique NetworkSwitch to an array', () => {
        const networkSwitchArray: INetworkSwitch[] = [{ id: 123 }, { id: 456 }, { id: 5013 }];
      ...
      it('should return initial array if no NetworkSwitch is added', () => {
        const networkSwitchCollection: INetworkSwitch[] = [{ id: 123 }];
        expectedResult = service.addNetworkSwitchToCollectionIfMissing(networkSwitchCollection, undefined, null);
        expect(expectedResult).toEqual(networkSwitchCollection);
      });
    });
  });
