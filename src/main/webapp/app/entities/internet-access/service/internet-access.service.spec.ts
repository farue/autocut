  ...
  describe('Service methods', () => {
    ...
    describe('addInternetAccessToCollectionIfMissing', () => {
      ...
      it('should add only unique InternetAccess to an array', () => {
        const internetAccessArray: IInternetAccess[] = [{ id: 123 }, { id: 456 }, { id: 45867 }];
      ...
      it('should return initial array if no InternetAccess is added', () => {
        const internetAccessCollection: IInternetAccess[] = [{ id: 123 }];
        expectedResult = service.addInternetAccessToCollectionIfMissing(internetAccessCollection, undefined, null);
        expect(expectedResult).toEqual(internetAccessCollection);
      });
    });
  });
