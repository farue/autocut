...
public class LaundryMachineProgramResourceIT {
    ...
    public void setup() {
        ...
        final LaundryMachineProgramResource laundryMachineProgramResource = new LaundryMachineProgramResource(laundryMachineProgramRepository);
        this.restLaundryMachineProgramMockMvc = MockMvcBuilders.standaloneSetup(laundryMachineProgramResource)
